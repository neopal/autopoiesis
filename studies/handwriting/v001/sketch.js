...
function draw(){
  ...
  const routes=routeFor('AUTOP0IESIS',r);ctx.lineCap='round';ctx.lineJoin='round';
  ...
  ctx.fillStyle='#b93c2e';ctx.font='15px monospace';ctx.fillText('PASSAGES / LOOPS / FATIGUE',46,64);
  ctx.fillStyle='rgba(21,21,20,.45)';ctx.fillText('v001 — writing without knowing the letter',46,678);
}
