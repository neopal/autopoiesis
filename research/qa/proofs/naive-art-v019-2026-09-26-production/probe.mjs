...
const port = 4190;
const proofDir = resolve('C:/Users/ASUS/autopoiesis/research/qa/proofs/naive-art-v019-2026-09-26-production');
...
async function main() {
  ...
  await blind.goto(`${baseUrl}/studies/naive-art/v019/?preview=1&static=1&blind=1`, { waitUntil: 'networkidle' });
  ...
  await current.goto(`${baseUrl}/currents/naive-art/`, { waitUntil: 'networkidle' });
