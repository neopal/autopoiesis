...
const proofDir = 'research/qa/proofs/naive-art-v009-2026-09-13';
const viewports = [
  [320, 568],
  [390, 844],
  [768, 1024],
...

{
  ...
  const events = observe(page);
  await page.setViewportSize({ width: 390, height: 844 });
  await page.goto(`${ROOT}/studies/naive-art/v009/?preview=1&static=1&blind=1`, { waitUntil: 'networkidle' });
