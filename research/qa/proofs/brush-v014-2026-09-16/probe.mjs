...
const canonical = `${base}/works/brush-2026-09-16/`;
const raw = `${base}/studies/p5-brush/v014/?preview=1&interaction=1`;
const blind = `${base}/studies/p5-brush/v014/?preview=1&static=1&blind=1`;
const proofDir = 'research/qa/proofs/brush-v014-2026-09-16';
const viewports = [
...

{
  ...
  await page.locator('#lift-tide').click();
  await page.waitForTimeout(80);
