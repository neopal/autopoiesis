...
const proofDir = resolve('research/qa/proofs/webgpu-v016-2026-09-25-production');
const viewports = [
...
try {
  ...
  await writeFile(resolve(proofDir, 'production-results.json'), `${JSON.stringify(results, null, 2)}\n`);
