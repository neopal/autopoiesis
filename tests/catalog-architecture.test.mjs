...
test('catalog is current -> daily work -> journal/critique data', () => {
  ...
  assert.equal(catalog.worksByCurrent.typography.length, 9);
  assert.deepEqual(catalog.worksByCurrent.typography.map((work) => work.date), ['2026-09-13', '2026-09-12', '2026-09-11', '2026-09-10', '2026-09-09', '2026-09-04', '2026-09-03', '2026-08-31', '2026-08-28']);
