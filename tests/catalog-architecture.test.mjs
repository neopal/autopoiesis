...
test('catalog is current -> daily work -> journal/critique data', () => {
  ...
  assert.equal(catalog.works.length, 58);
  ...
  assert.deepEqual(catalog.worksByCurrent.svg.map((work) => work.id), ['svg-2026-09-13', 'svg-2026-09-12', 'svg-2026-09-10', 'svg-2026-09-09', 'svg-2026-09-08', 'svg-2026-09-07', 'svg-2026-09-04', 'svg-2026-09-03', 'svg-2026-09-02', 'svg-2026-08-31']);
